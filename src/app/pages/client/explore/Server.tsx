...
const useRoomTypeFilters = (): RoomTypeFilter[] => {
  ...
  return useMemo(
    () => [
      {
        title: t.Pages.Explore.Server.all,
        value: undefined,
      },
      {
        title: t.Pages.Explore.Server.spaces,
        value: RoomType.Space,
      },
      {
        title: t.Pages.Explore.Server.rooms,
        value: 'null',
      },
    ],
    [t]
...
function Search({ active, loading, searchInputRef, onSearch, onReset }: SearchProps) {
  ...
  return (
    <Box as="form" direction="Column" gap="100" onSubmit={handleSearchSubmit}>
      ...
      <Text size="L400">{t.Pages.Explore.Server.search}</Text>
      <Input
        ref={searchInputRef}
        ...
        size="500"
        variant="Background"
        placeholder={t.Pages.Explore.Server.searchPlaceholder}
        before={
          active && loading ? (
        ...
        after={
          active ? (
            <Chip
              ...
              onClick={onReset}
            >
              <Text size="B300">{t.Pages.Explore.Server.clear}</Text>
            </Chip>
          ) : (
            <Chip type="submit" variant="Primary" size="400" radii="Pill" outlined>
              <Text size="B300">{t.Pages.Explore.Server.enter}</Text>
            </Chip>
          )
        }
      />
...
function ThirdPartyProtocolsSelector({
  ...
  return (
          ...
          <Menu variant="Surface">
            ...
            >
              <Text style={{ padding: config.space.S100 }} size="L400" truncate>
                {t.Pages.Explore.Server.protocols}
              </Text>
    ...
    >
      ...
      >
        <Text size="T200" truncate>
          {selectedInstance?.desc ?? t.Pages.Explore.Server.matrix}
        </Text>
      </Chip>
    </PopOut>
  );
  ...
  return (
          ...
          <Menu variant="Surface">
            <Box direction="Column" gap="400" style={{ padding: config.space.S300 }}>
              <Box direction="Column" gap="100">
                <Text size="L400">{t.Pages.Explore.Server.presets}</Text>
              ...
              <Box as="form" onSubmit={handleLimitSubmit} direction="Column" gap="300">
                <Box direction="Column" gap="100">
                  <Text size="L400">{t.Pages.Explore.Server.customLimit}</Text>
                  <Input
                    name="limitInput"
                    size="300"
                    variant="Background"
                ...
                <Button type="submit" size="300" variant="Primary" radii="400">
                  <Text size="B300">{t.Pages.Explore.Server.changeLimit}</Text>
                </Button>
              </Box>
            </Box>
          </Menu>
    ...
    >
      <Chip
        ...
        after={<Icon size="100" src={Icons.ChevronBottom} />}
      >
        <Text size="T200" truncate>{t.Pages.Explore.Server.pageLimit(limit)}</Text>
      </Chip>
    </PopOut>
  );
}
              ...
              <Box direction="Column" gap="600">
                ...
                <Box direction="Column" gap="400">
                  <Box direction="Column" gap="300">
                    {isSearch ? (
                      <Text size="H4">{t.Pages.Explore.Server.resultsFor(serverSearchParams.term!)}</Text>
                    ) : (
                      <Text size="H4">{t.Pages.Explore.Server.popularCommunities}</Text>
                    )}
                    <Box gap="200">
                    ...
                    (data.chunk.length > 0 ? (
                          ...
                          <Box justifyContent="Center" gap="200">
                            ...
                            >
                              <Text size="B300" truncate>
                                {t.Pages.Explore.Server.previousPage}
                              </Text>
                            </Button>
                            ...
                            >
                              <Text size="B300" truncate>
                                {t.Pages.Explore.Server.nextPage}
                              </Text>
                            </Button>
                          </Box>
                        )}
                      ...
                      >
                        ...
                        <Text size="T300" align="Center">
                          {t.Pages.Explore.Server.noCommunities}
                        </Text>
                      </Box>
                    ))}
                </Box>
