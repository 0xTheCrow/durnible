            ...
            {(match, doMatch, passRef, confPassRef) => (
              <>
                <Box grow="Yes" direction="Column" gap="100">
                  <Text size="L400">{t.Settings.DevicesPage.newPassword}</Text>
                  <PasswordInput
                    ref={passRef}
                    name="passwordInput"
                    size="400"
                ...
                <Box grow="Yes" direction="Column" gap="100">
                  <Text size="L400">{t.Settings.DevicesPage.confirmPassword}</Text>
                  <PasswordInput
                    ref={confPassRef}
...
function ExportKeysTile() {
  ...
  return (
    <>
      <SettingTile
        title={t.Settings.DevicesPage.exportTitle}
        description={t.Settings.DevicesPage.exportDescription}
        after={
          <Box>
            <Button
              type="button"
  ...
  return (
    <SettingTile>
      <Box as="form" onSubmit={handleSubmit} direction="Column" gap="100">
        <Box gap="200" alignItems="End">
          <Box grow="Yes" direction="Column" gap="100">
            <Text size="L400">{t.Settings.DevicesPage.password}</Text>
            <PasswordInput
              name="passwordInput"
              size="400"
              variant="Secondary"
          ...
          >
            <Text as="span" size="B400">
              {t.Settings.DevicesPage.decrypt}
            </Text>
          </Button>
        </Box>
...
function ImportKeysTile() {
  ...
  return (
    <>
      <SettingTile
        title={t.Settings.DevicesPage.importTitle}
        description={t.Settings.DevicesPage.importDescription}
        after={
          <Box>
            {file ? (
              <Button
...
export function LocalBackup() {
  ...
  return (
    <Box direction="Column" gap="100">
      <Text size="L400">{t.Settings.DevicesPage.localBackup}</Text>
      <SequenceCard
