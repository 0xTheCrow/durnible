...
import { buildTimelineDescriptors, groupsEqual } from './buildTimelineDescriptors';
import { computeImageGroups } from '../../../utils/buildTimelineDescriptors';
import type {
  ImageGroupsSnapshot,
  TimelineEventInput,
...
export function RoomTimelineV1({
  room,
  eventId,
  roomInputRef,
  editorInputRef,
