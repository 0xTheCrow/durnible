...
export const LogoutDialog = forwardRef<HTMLDivElement, LogoutDialogProps>(({ onClose }, ref) => {
    ...
    <Dialog variant="Surface" ref={ref}>
      ...
      <Box style={{ padding: config.space.S400 }} direction="Column" gap="400">
        ...
        <Box direction="Column" gap="200">
          ...
          <Button variant="Secondary" fill="Soft" onClick={onClose} disabled={ongoingLogout}>
