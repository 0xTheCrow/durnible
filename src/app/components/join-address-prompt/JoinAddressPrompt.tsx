      ...
      <OverlayCenter>
        ...
        >
          <Dialog variant="Surface">
            ...
            >
              <Box grow="Yes">
                <Text size="H4">{t.JoinAddressPrompt.title}</Text>
              </Box>
            ...
            >
              <Box direction="Column" gap="200">
                <Text priority="400" size="T300">
                  {t.JoinAddressPrompt.description}
                </Text>
              ...
              <Box direction="Column" gap="100">
                <Text size="L400">{t.JoinAddressPrompt.addressLabel}</Text>
                <Input
                  size="500"
                  autoFocus
                  name="addressInput"
                  variant="Background"
                  placeholder={t.JoinAddressPrompt.addressPlaceholder}
                  required
                />
                {invalid && (
                  <Text size="T200" style={{ color: color.Critical.Main }}>
                    <b>{t.JoinAddressPrompt.invalidAddress}</b>
                  </Text>
                )}
              </Box>
              <Button type="submit" variant="Primary">
                <Text size="B400">{t.JoinAddressPrompt.open}</Text>
              </Button>
            </Box>
          </Dialog>
        </FocusTrap>
