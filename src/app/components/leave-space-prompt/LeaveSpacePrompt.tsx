      ...
      <OverlayCenter>
        ...
        >
          <Dialog variant="Surface">
            ...
            >
              <Box grow="Yes">
                <Text size="H4">{t.LeaveSpacePrompt.title}</Text>
              </Box>
            ...
            <Box style={{ padding: config.space.S400 }} direction="Column" gap="400">
              <Box direction="Column" gap="200">
                <Text priority="400">{t.LeaveSpacePrompt.confirmMessage}</Text>
                {leaveState.status === AsyncStatus.Error && (
                  <Text style={{ color: color.Critical.Main }} size="T300">
                    {t.LeaveSpacePrompt.failedToLeave} {leaveState.error.message}
                  </Text>
                )}
              </Box>
              <Button
              ...
              >
                <Text size="B400">
                  {leaveState.status === AsyncStatus.Loading
                    ? t.LeaveSpacePrompt.leaving
                    : t.LeaveSpacePrompt.leave}
                </Text>
              </Button>
            </Box>
          </Dialog>
